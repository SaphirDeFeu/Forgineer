...
public class AutomatonEntityModel extends EntityModel<AutomatonEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData bb_main = modelPartData.addChild("bb_main", ModelPartBuilder.create().uv(0, 0).cuboid(-8.0F, -37.0F, -4.0F, 16.0F, 20.0F, 8.0F, new Dilation(0.0F))
		.uv(0, 28).cuboid(-12.0F, -35.0F, -2.0F, 4.0F, 32.0F, 4.0F, new Dilation(0.0F))
		.uv(16, 28).cuboid(8.0F, -35.0F, -2.0F, 4.0F, 32.0F, 4.0F, new Dilation(0.0F))
		.uv(32, 28).cuboid(-14.0F, -10.0F, -5.0F, 2.0F, 10.0F, 10.0F, new Dilation(0.0F))
		.uv(48, 0).cuboid(12.0F, -10.0F, -5.0F, 2.0F, 10.0F, 10.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 24.0F, 0.0F));
