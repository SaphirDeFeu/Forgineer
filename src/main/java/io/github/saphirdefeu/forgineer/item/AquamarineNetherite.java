...
public class AquamarineNetherite extends Item {

    private static final EntityAttributeModifier entityAttributeModifier = new EntityAttributeModifier(
            Identifier.of(Forgineer.MOD_ID, "gemstone"), 4.0, EntityAttributeModifier.Operation.ADD_VALUE
    );
    ...
    public AquamarineNetherite(Settings settings) {
        super(settings);
    }
