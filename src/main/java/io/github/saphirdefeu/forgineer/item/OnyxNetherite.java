...
public class OnyxNetherite extends Item {

    private static final EntityAttributeModifier entityAttributeModifier = new EntityAttributeModifier(
            Identifier.of(Forgineer.MOD_ID, "gemstone"), 10.0, EntityAttributeModifier.Operation.ADD_VALUE
    );
    ...
    public OnyxNetherite(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        ...
        final double armorModifier = user.getAttributes().getModifierValue(EntityAttributes.ARMOR, Identifier.of(Forgineer.MOD_ID, "gemstone"));
        ...
        Gemstone.saveAttributeModifier(world, user, entityAttributeModifier, EntityAttributes.ARMOR);
