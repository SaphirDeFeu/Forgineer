...
public class SapphireNetherite extends Item {

    private static final EntityAttributeModifier entityAttributeModifier = new EntityAttributeModifier(
            Identifier.of(Forgineer.MOD_ID, "gemstone"), 0.2, EntityAttributeModifier.Operation.ADD_VALUE
    );
    ...
    public SapphireNetherite(Settings settings) {
        super(settings);
    }
